...
BLACKLIST_FILTERS = [
    ...
    in {
        ...
        os.removedirs,
        os.rmdir,
        os.fchdir if hasattr(os, "fchdir") else None,
        os.setuid if hasattr(os, "setuid") else None,
        os.fork if hasattr(os, "fork") else None,
        os.forkpty if hasattr(os, "forkpty") else None,
        ...
        os.replace,
        os.unlink,
        os.fchmod if hasattr(os, "fchmod") else None,
        os.fchown if hasattr(os, "fchown") else None,
        os.chmod,
        os.chown if hasattr(os, "chown") else None,
        os.chroot if hasattr(os, "chroot") else None,
        os.fchdir if hasattr(os, "fchdir") else None,
        os.lchown if hasattr(os, "lchown") else None,
        os.getcwd,
        os.chdir,
        shutil.rmtree,
        shutil.move,
